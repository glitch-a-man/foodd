        ...
        <main className="w-full h-[100dvh] bg-black text-white p-6 flex flex-col">
            ...
            <div className="flex-1 flex flex-col justify-center max-w-sm mx-auto w-full">
                <div className="mb-12">
                    ...
                    <p className="text-gray-400 text-lg">Sign in to continue your food discovery journey.</p>
                </div>
                ...
                <div className="space-y-4">
                    ...
                    <div className="relative py-4">
                        ...
                        <div className="relative flex justify-center text-xs uppercase">
                            <span className="bg-black px-2 text-gray-500">Secure Authentication</span>
                        </div>
                    </div>
                </div>
