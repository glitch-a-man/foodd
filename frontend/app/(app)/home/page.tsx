    ...
    return (
        <div className="min-h-full bg-black text-white p-4 pb-24 overflow-y-auto no-scrollbar">
            ...
            >
                <div className="flex items-center gap-3">
                    <div className="relative w-12 h-12 rounded-2xl overflow-hidden border border-white/10">
                        {user?.image ? (
                            ...
                            <div className="w-full h-full bg-gradient-to-tr from-orange-500 to-yellow-500" />
                        )}
                    </div>
                    <div>
                        <h1 className="text-lg font-bold leading-tight">
                            Hi, <span className="text-orange-500">{user?.name?.split(' ')[0] || 'Foodie'}</span> 👋
                        </h1>
                ...
                <button className="w-12 h-12 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center relative transition-transform active:scale-90">
                    <Bell size={22} className="text-gray-300" />
                    <span className="absolute top-3 right-3 w-2.5 h-2.5 bg-orange-500 border-2 border-black rounded-full" />
                </button>
            </motion.div>
